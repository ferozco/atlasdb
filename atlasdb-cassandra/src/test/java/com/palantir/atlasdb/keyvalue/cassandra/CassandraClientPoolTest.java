...
public class CassandraClientPoolTest {
    ...
    public void attemptsShouldBeCountedPerHost() {
        when(config.servers()).thenReturn(new CassandraServersConfigs.DeprecatedCassandraServersConfig());
    ...
    public void hostIsAutomaticallyRemovedOnStartup() {
        when(config.servers())
                .thenReturn(new CassandraServersConfigs.DeprecatedCassandraServersConfig(HOST_1, HOST_2, HOST_3));
    ...
    public void hostIsAutomaticallyAddedOnStartup() {
        when(config.servers())
                .thenReturn(new CassandraServersConfigs.DeprecatedCassandraServersConfig(HOST_1));
        when(config.autoRefreshNodes()).thenReturn(true);
    ...
    public void hostIsAutomaticallyAddedOnRefresh() {
        when(config.servers())
                .thenReturn(new CassandraServersConfigs.DeprecatedCassandraServersConfig(HOST_1, HOST_2));
        when(config.autoRefreshNodes()).thenReturn(true);
    ...
    private CassandraClientPoolImpl clientPoolWith(
        ...
        when(config.servers()).thenReturn(new CassandraServersConfigs.DeprecatedCassandraServersConfig(servers));
